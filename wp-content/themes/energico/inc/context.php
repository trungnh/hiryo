...
function energico_utility() {
	return energico_theme()->get_core()->modules['cherry-utility'];
}
 ...
 * @return void
 */
function energico_header_class( $classes = array() ) {
	$classes[] = 'site-header';
	$classes[] = get_theme_mod( 'header_layout_type' );
	echo energico_get_container_classes( $classes, 'header' );
}
 ...
 * @return  void
 */
function energico_header_container_class( $classes = array() ) {
 ...
 * @return void
 */
function energico_content_class( $classes = array() ) {
	$classes[] = 'site-content';
	echo energico_get_container_classes( $classes, 'content' );
}
 ...
 * @return void
 */
function energico_footer_class( $classes = array() ) {
	$classes[] = 'site-footer';
	$classes[] = get_theme_mod( 'footer_layout_type' );
	echo energico_get_container_classes( $classes, 'footer' );
}
 ...
 * @return string
 */
function energico_get_container_classes( $classes, $target = 'content' ) {
	global $post;
 ...
 * @return void
 */
function energico_primary_content_class( $classes = array() ) {
	echo energico_get_layout_classes( 'content', $classes );
}
 ...
 * @return void
 */
function energico_sidebar_class( $classes = array() ) {
	echo energico_get_layout_classes( 'sidebar', $classes );
}
 ...
 * @return string
 */
function energico_get_layout_classes( $layout = 'content', $classes = array() ) {
	...
	$layout_classes = ! empty( energico_theme()->layout[ $sidebar_position ][ $sidebar_width ][ $layout ] ) ? energico_theme()->layout[ $sidebar_position ][ $sidebar_width ][ $layout ] : array();
	...
	$layout_classes = apply_filters( "energico_{$layout}_classes", $layout_classes );
 ...
 * @return string|void
 */
function energico_posts_list_class( $classes = array(), $echo = true ) {
	$layout_type      = get_theme_mod( 'blog_layout_type', energico_theme()->customizer->get_default( 'blog_layout_type' ) );
	$layout_type      = ! is_search() ? $layout_type : 'default';
	$sidebar_position = get_theme_mod( 'sidebar_position', energico_theme()->customizer->get_default( 'sidebar_position' ) );
	...
	foreach ( $sidebars as $sidebar ) {
		if ( energico_widget_area()->is_active_sidebar( $sidebar ) ) {
			$has_sidebars = true;
		}
	}
	...
	$classes = apply_filters( 'energico_posts_list_class', $classes );
